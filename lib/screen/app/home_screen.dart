...
import 'package:volunteer_app/screen/widget/home_section.dart';
    ...
    return Scaffold(
      ...
      body:ListView(
        ...
        children: [
          ...
          SizedBox(height: 20.h,),
          HomeSection(title: 'ابحث من خلال المنظمة',Subtitle: 'رؤية الكل',),
          ConstrainedBox(
          ...
          SizedBox(height: 20.h,),
          HomeSection(title: 'ما هو الفرع المناسب لك ؟',Subtitle: 'رؤية الكل',),
          GridView.builder(
